...
const proyectos = [
  {
    ...
    content: (
      <div className="flex flex-col gap-8 items-center justify-center h-full min-h-[400px]">
        <h3 className="text-3xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-100 text-center animate-pulse">
          Coming Soon
        </h3>
        <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-xl font-sans max-w-2xl mx-auto text-center">
          I'm working on something exciting! Stay tuned for updates.
        </p>
      </div>
    ),
  },
  {
    src: "/images/inicio_rede.jpeg",
    ...
    content: (
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-2 flex-wrap justify-center mt-4">
          ...
          <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-xs">Django</span>
          <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-xs">HTML</span>
          <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-xs">SQLite</span>
          <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-xs">Full-Stack</span>
        </div>
        {/* Introduction */}
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-4 md:p-14 rounded-3xl flex flex-col items-center gap-6">
          <h3 className="text-2xl md:text-3xl font-bold text-neutral-800 dark:text-neutral-100 mb-2 text-center">Municipal Sports Management System</h3>
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-xl font-sans max-w-2xl mx-auto text-center">
        ...
        {/* Description */}
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-4 md:p-14 rounded-3xl flex flex-col items-center gap-6">
          <h3 className="text-2xl md:text-3xl font-bold text-neutral-800 dark:text-neutral-100 mb-2 text-center">Efficient & Localized Solution</h3>
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-xl font-sans max-w-2xl mx-auto text-center">
            <span className="font-bold text-neutral-700 dark:text-neutral-200">Built with Django and Python.</span> This project utilizes a monolithic architecture with server-side rendered HTML templates and a SQLite database. It demonstrates the ability to deliver practical, real-world solutions for community needs, balancing functionality with ease of use.
          </p>
          <CardContainer>
            <CardItem translateZ={100}>
              <img
  ...
  <>
    ...
    <section className="relative w-full max-w-full md:max-w-2xl mx-auto mb-12 mt-12 p-3 md:p-6 rounded-xl bg-card shadow-lg">
      ...
      <div className="text-center mb-8">
        <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-lg font-sans max-w-2xl mx-auto">
          Here you can explore a collection of my personal and academic projects. Each project represents a step in my journey as a developer, showcasing my skills in full-stack development, data science, and cybersecurity. From web applications to satellite image analysis, these works demonstrate my passion for building efficient and impactful solutions.
        </p>
      </div>
